...
echo -e "  ${B}2.${N} Stack starten: cd /opt/monorepo && bash scripts/stack-up.sh"
echo -e "     (spaeter als Alias einfach: up - startet GESTAFFELT, damit Immich,"
echo -e "      OpenCloud und Paperless beim Erststart nicht gleichzeitig auf die"
echo -e "      USB-Platte schreiben und den Host ueberlasten)"
